  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Gradient overlays */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#060f22]/95 via-[#060f22]/85 to-[#060f22]/60" />
        <div className="absolute inset-0 bg-gradient-to-t from-[#060f22] via-transparent to-[#060f22]/60" />
      </div>

      {/* Decorative elements - hidden on small mobile to avoid overflow */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
        <div className="max-w-3xl">
          {/* Badge */}
          <div
            className="animate-on-enter opacity-0 translate-y-8 transition-all duration-700 delay-100 inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-[#F7931E]/10 border border-[#F7931E]/30 mb-5 sm:mb-6"
          >
          ...
          {/* Title */}
          <h1
            className="animate-on-enter opacity-0 translate-y-8 transition-all duration-700 delay-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-3 sm:mb-4"
          >
            FELLOWSHIP{" "}
          ...
          {/* Subtitle */}
          <p
            className="animate-on-enter opacity-0 translate-y-8 transition-all duration-700 delay-300 text-[#F7931E] text-sm sm:text-base md:text-lg font-medium tracking-wider sm:tracking-widest uppercase mb-5 sm:mb-6 leading-relaxed"
          >
          ...
          {/* CTAs */}
          <div
            className="animate-on-enter opacity-0 translate-y-8 transition-all duration-700 delay-500 flex flex-col sm:flex-row gap-3 sm:gap-4"
          >
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full bg-[#F7931E] text-white font-bold text-sm sm:text-base hover:bg-[#e07010] transition-all duration-300 shadow-2xl hover:shadow-[#F7931E]/40 active:scale-95 glow-gold w-full sm:w-auto"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full border border-white/20 text-white font-semibold text-sm sm:text-base hover:border-[#F7931E]/50 hover:bg-white/5 active:scale-95 transition-all duration-300 w-full sm:w-auto"
            >
              QUERO SABER MAIS
          ...
          <div
            className="animate-on-enter opacity-0 translate-y-8 transition-all duration-700 delay-600 grid grid-cols-2 sm:flex sm:flex-wrap gap-4 sm:gap-8 mt-10 sm:mt-14"
          >
            {[
              { value: "18h (PT)", label: "Todas as 5ª Feiras" },
              { value: "Online", label: "Transmissão Privada" },
              { value: "400+", label: "Vidas Impactadas" },
              { value: "Global", label: "Líderes de Vários Países" },
            ].map((stat) => (
              <div key={stat.label} className="flex flex-col">
                <span className="text-xl sm:text-2xl font-bold text-[#F7931E]">{stat.value}</span>
                <span className="text-xs sm:text-sm text-white/50 leading-tight">{stat.label}</span>
              </div>
            ))}
          </div>
        </div>
